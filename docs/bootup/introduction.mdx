---
title: Introduction
description: Get started with Xpay
---
...
<Accordions type="single">
  <Accordion title="Tax Compliance Nightmare">
  ...
  <Accordion title="Complex Billing Infrastructure">
  ...
  <Accordion title="Manual Access & Delivery Overhead">
  ...
  <Accordion title="High Processing Costs">
...
<Steps>
  ...
  <Step>
    ...
    <Tabs items={['No-Code (Fastest)', 'Embedded', 'Full API (Maximum Control)']}>
      ...
      <Tab value="Full API (Maximum Control)">
...
<Tabs items={['Individual Developers', 'Small Teams', 'Growing Businesses']}>
  <Tab value="Individual Developers">
    <Cards>
